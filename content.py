...
INTRO_TEXT = """
As an immigrant, one of the first things you notice about this country—or rather, this continent—is how vast and diverse it is. Although it's considered one country, many aspects of life, including laws and legal obligations, vary significantly from state to state. Naturally, this leads to wide differences in living costs across the country.

For me, healthcare-related aspects—laws, costs, and quality—have been especially interesting. Having lived in only one state, I've always been curious about how healthcare experiences differ elsewhere.
...
SECTION_1_TITLE = "1. How It Started: Average (Mode) Medicare Cost per Person"
...
SECTION_2_TITLE = "2. How Is It Related to Income?"
...
SECTION_3_TITLE = "3. Range Matters"
